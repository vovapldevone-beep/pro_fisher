<template>
    <nav
        class="group fixed left-0 top-[65px] z-40 flex h-[calc(100vh-65px)] w-16 flex-col overflow-hidden bg-[#1a1f2e] shadow-xl transition-[width] duration-200 ease-in-out hover:w-56"
    >
...
const FishIcon = () =>
    h('svg', { viewBox: '0 0 24 24', fill: 'currentColor', class: 'h-6 w-6 shrink-0' }, [
        h('path', {
            d: 'M19.5 12c0 0-3-5-7.5-5S4.5 12 4.5 12 7.5 17 12 17s7.5-5 7.5-5zm1 0 3-2.5v5L20.5 12zM14 10.5a2 2 0 1 1-4 0 2 2 0 0 1 4 0z',
        }),
    ]);
